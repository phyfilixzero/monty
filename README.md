...
> This was a single project done by my humble self uche felix (https://github.com/phyfilixzero/)
...
```bash
git clone https://github.com/phyfilixzero/alx-low_level_programming.git
cd monty
